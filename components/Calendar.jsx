...
export default class extends Component {
    ...
    getInitialMonthes() {
        ...
        for (let i = 0, indexMoment = moment({
                M: this.state.month,
                y: this.state.year
            }); i < this.state.monthesCount; i++, indexMoment.add(1, 'month')) {
            ...
            < tr > {
                rows[0].map((cell) => {
                    return <td key = {
                        ...
                        cell.moment.format('dddd')
                    } < /td>;
                })
            } < /tr> < /tbody> < /table> < div id = 'calendar'
